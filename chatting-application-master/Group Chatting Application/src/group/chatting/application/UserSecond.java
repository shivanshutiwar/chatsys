...
public class UserSecond extends JFrame implements ActionListener, Runnable{
    ...
    UserSecond(){
       ...
       JLabel l4 = new JLabel("Guddu, Kaaleen, Bablu, Sweety, IG Dubey, Shukla");
       ...
       a1.setBackground(new Color(7, 96, 84));
       ...
       t1.setFont(new Font("SAN_SERIF", Font.PLAIN, 16));//SEND WALA ANADAR TEXT FONT H
       add(t1);
       ...
       b1.setFont(new Font("SAN_SERIF", Font.PLAIN, 16));//SEND WALA TEXT FONT H
